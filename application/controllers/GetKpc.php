...
class GetKpc extends CI_Controller {
	...
	{
		$this->load->view('adm_laporan_rekap');
	}
	...
	public function GetData()
	{
		...
		$sp_name = 'Ipos_getNopenAgen';//'Ipos_ReportRekap';//'Ipos_getPosting';
		$par_data=$kprknya;// '00|40000|40511C1|EC2|2019-12-17|2019-12-17';
	...
	//curl_setopt($ch, CURLOPT_URL, "https://magenpos.posindonesia.co.id:6466/getreport");  
		...
		for ($i=0; $i < $jmlproduk; $i++)
		{
			...
			$kprk=$kprk.$data[$i]["nopen"]."|".$data[$i]["ketnopen"]."#";
			$result = array(
