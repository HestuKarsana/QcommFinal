...
postOrder($PETUGAS,$IDORDER,$NAMAPENGIRIM,$ALAMATPENGIRIM,
	...
	*/
	...
	public function insorder()
    {
		...
		$itemValuenya=$_POST['itemValue'];
		if ($itemValuenya==''){
			$itemValue='0';
		} else {$itemValue=$_POST['itemValue'];}
		//$itemValue=$_POST['itemValue'];
		$isinyakirimannya=$_POST['contentDesc'];
		if ($isinyakirimannya=='') {$contentDesc='-';}
		else {$contentDesc=$_POST['contentDesc'];}
		$no_group_order='001';
		//$VA = '60012345678';
		$VA = '-';
...
NPWP, 		17
		...
		*/
		$param4="-|".$receiverName."|".$receiverAddr."|-|-|".$receiverVill."|".$receiverSubDist."|-|".$receiverCity."|".$receiverProv."|-|".$receiverCountry."|".$receiverPosCode."|".$receiverPhone."|".$receiverPhone."|".$receiverEmail."|-|-";//detil penerima
