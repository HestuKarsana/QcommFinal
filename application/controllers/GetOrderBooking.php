...
class GetOrderBooking extends CI_Controller {
	...
	public function GetData()
	{
		...
		*/
		...
		$param4="";
		$param5="";
		$sp_name = 'Ipos_getPostingPebisol';//'Ipos_ReportRekap';//'Ipos_getPosting';
		$par_data= $userlogin.'|'.$tg1.'|'.$tg2;//'2019-12-17|2019-12-24';//'00|40000|40511C1|EC2|2019-12-17|2019-12-17';//'900000001|2019-12-19';
		...
		$htmldata='<center><div id="outtable">
						    ...
						    <font size=2%><h3>REPORT ORDER BOOKING</h3>
									 Tanggal : '.$tg1.' s/d '.$tg2.'
									<br>
							...
							<tr bgcolor=#DCDCDC>
							    <th class="short">#</th>
								<th class="normal" align="center">UserID</th>
								<th class="normal">ID Order</th>
