...
class Secure extends MY_Controller 
{
									...
									if($code<>'00') {
										$url=base_url();
										    ...
										    //redirect('order');
												...
												$data = array('success' => '1', 
													...
													"wkt_mess":"2019-12-17 13:04:29.265838"}
													  */
											//$akses=$response['success'];
											//$this->load->libraries('Session');
											//echo $this->session->set_flashdata('ses_id_usernya','Iwan Kurniawan');
											//$userid=$response["userid"];
											...
											//if($akses){			
													...
													$this->session->set_userdata('ses_level','agen');
													$this->session->set_userdata('ses_level_caption','Agen');
	...
	function logout()
	{
		...
		$this->session->unset_userdata('ses_level','agen');
