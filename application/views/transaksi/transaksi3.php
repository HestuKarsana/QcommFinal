		...
		<div class="panel-body">
			...
			<div class='row'>
				<div class='col-sm-3'>
						...
						<div class="panel-body">
							...
							<div class="form-horizontal">
								<div class="form-group">
									<label class="col-sm-4 control-label">No.Barcode</label>
									<div class="col-sm-8">
					...
					<div class="panel panel-primary">
						<div class="panel-heading"><i class='fa fa-file-text-o fa-fw'></i> Data Transaksi</div>
						<div class="panel-body">
							...
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type='text' name='jmltrx' class='form-control input-sm' id='jmltrx'>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">Batal</label>
									<div class="col-sm-8">
										<input type='text' name='batal' class='form-control input-sm' id='batal' >
									</div>
								</div>
					...
					<div class="panel panel-primary" id='PelangganArea'>
						<div class="panel-heading"><i class='fa fa-user'></i> Petugas Entri</div>
						<div class="panel-body">
							<div class="form-group">
								<div class="form-group">
					...
					<table class='table table-bordered' id='TabelTransaksi'>
						<thead>
							<tr>
								...
								<th style='width:210px;'>Ext ID</th>
								<th>Pengirim / Penerima</th>
								<th style='width:120px;'>Tarif</th>
								<th style='width:75px;'>Jml</th>
					...
					<div class='row'>
					   <div class='col-sm-7'>
					       <div class="form-horizontal">
						       ...
						       <div class='row'>
									<div class='col-sm-6' style='padding-right: 0px;'>
										Kodepos Asal <input type='text' id='kodepossip' class='form-control' >
									</div>
									
								</div>
								<div class='row'>
									<div class='col-sm-6' style='padding-right: 0px;'>
										Kodepos Tujuan <input type='text' id='kodepossial' class='form-control' >
									</div>
									
								</div>
								<div class='row'>
									<div class='col-sm-6' style='padding-right: 0px;'>
										Berat <input type='text' id='berat' class='form-control' >
									</div>
									
								</div>
								
								<div class='col-sm-6'>
										<button type='button' class='btn btn-primary btn-block' id='GetTarif'>
											<i class='fa fa-floppy-o'></i> Get Tarif
										</button>
									</div>
								

								<div class='col-sm-6' name='tampiltarif' id='tampiltarif'>DISINI
...
$('#GetTarif').on('click', function (evt) {
