...
<div class="container-fluid">
	<div class="login-panel">
		<center>
			...
			<img width="89px" height="55px" src="<?php echo config_item('img'); ?>logo_1.gif"/><br>
			<img  width="245px" height="40px" src="<?php echo config_item('img'); ?>logo.png" />
		</center>
		<div class='panel panel-default'>
			<div class='panel-body'>
				
				<form class="form-signin" action="<?php echo base_url().'index.php/admin/auth'?>" method="post">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" id="usernameadmin" name="usernameadmin" class="form-control" placeholder="Username" autocomplete=off required autofocus>
