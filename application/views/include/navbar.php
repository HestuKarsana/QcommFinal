							...
							<li class="dropdown <?php if($controller == 'transaksi') { echo 'active'; } ?>">
								...
								<ul class="dropdown-menu">
									<li><a href="<?php   echo base_url().'index.php/transaksi'  ?>">Entri Data</a></li>
										<li><a href="<?php   echo base_url().'index.php/cetakulang_resi'  ?>">Cetak Barcode</a></li>
									<li><a href="<?php   echo base_url().'index.php/bayar_resi'  ?>">Pembayaran Kiriman</a></li>
								    <li><a href="<?php   echo base_url().'index.php/batal_resi'  ?>">Pembatalan Kiriman</a></li>
