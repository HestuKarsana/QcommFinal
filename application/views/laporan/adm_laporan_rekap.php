...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Rekap Transaksi</h5>
			<hr />
			...
			<div class="row">
			    <div class="col-sm-4">
				 ...
				 <div class="col-sm-4">
				    <div class="form-horizontal">
					    <div class="form-group">
						    <label class="col-sm-2 control-label">Kpc</label>
							<div class="col-sm-8">
							
							<select name='kpc' id='kpc' class='form-control input-sm' <?php //echo $disabled; ?> style='resize: vertical; width:100%;'>
								<!--option value='00' style='resize: vertical; width:100%;'>Reg</option-->
								<?php
								     //echo "<option  value=$i>$i</option>";
								?>
...
function CekReport()
{
		...
		// {
			//alert('tes');
			var TglAwal,TglAkhir,RegNya,KprkNya,Kpcnya;
			TglAwal='';
			TglAkhir='';
			RegNya='';
			KprkNya='';
			...
			//$('#tampilOrder').hide();
			$.ajax ({ 
					   url: '<?= base_url() ?>index.php/GetReportRekap/GetData',
					   type: "post",
					   dataType: 'html',
					   //dataType: 'json',
					   delay: 250,
					 //  data :{kodepossip:kodepossip,kodepossial:kodepossial,berat:berat,anb:anb},
					   data :{TglAwal:TglAwal,TglAkhir:TglAkhir,RegNya:RegNya,KprkNya:KprkNya,Kpcnya:Kpcnya},
...
$(document).ready(function() 
{
 ...
 $(document).ready(function() 
{
    $("#kantorpar").change(function() 
	{
	    var IdKprk;
        IdKprk='';
		IdKprk= $("#kantorpar").val();
		//alert(IdKprk);
			$.ajax
			  ({
				url: '<?= base_url() ?>index.php/GetKpc/GetData',
					  type: "post",
					  dataType: 'json',
					  delay: 250,
					  data :{IdKprk:IdKprk},
				...
				success : function(response) 
				{
				 var html = '';
				  var i;
				  var myData2= response.nopend;
				//  alert(response);
				  var mySplitResult2 = myData2.split('#');
				  var pjgdata2=response.jml;
				  // if(IdReg!='00'){
					  // html += '<option>'+'00000|Semua Kprk'+'</option>';
				  // }
				  html += '<option>'+'0000000|Semua Kpc'+'</option>';
				  for(i=0; i<pjgdata2; i++)
				  {
					  
					  html += '<option>'+mySplitResult2[i]+'</option>';
				  }	
				  $("#kpc").html(html);  
