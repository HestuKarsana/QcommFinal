			...
			<div class='row'>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<div class="form-horizontal">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">Batal</label>
									<div class="col-sm-8">
										<input type='text' name='tanggal' class='form-control input-sm' id='tanggal' value="<?php echo date('Y-m-d H:i:s'); ?>" <?php echo $disabled; ?>>
									</div>
								</div>
				...
				<div class='col-sm-9'>
					<h5 class='judul-transaksi'>
						<i class='fa fa-shopping-cart fa-fw'></i> Ritel <i class='fa fa-angle-right fa-fw'></i> Transaksi
					...
					<div class='alert alert-info TotalBayar'>
						...
						<i class='fa fa-plus fa-fw'></i> Baris Baru (F7)</button-->
						<i class='fa fa-plus fa-fw'></i>Produk : <span id='Produk'></span>
					...
					<div class='row'>
						<div class='col-sm-7'>
							...
							<input type="text" class='form-control input-sm' id="idorder" name="idorder" placeholder="Masukkan idorder" style='resize: vertical; width:83%;'/>
								<button type='button' class='btn btn-warning btn-block' id='cekOrder' style='resize: vertical; width:83%;'>
											 Get Order
								</button>
										
							<br/>
							
							<p><i class='fa fa-user'></i> <b>Pengirim</b></p>
							<textarea name='catatan' id='pengirim' class='form-control' rows='2' placeholder="Data pengirim" style='resize: vertical; width:83%;'></textarea>
							
							<br/>
							<p><i class='fa fa-user'></i> <b>Penerima</b></p>
							<textarea name='catatan' id='penerima' class='form-control' rows='2' placeholder="Data Penerima" style='resize: vertical; width:83%;'disabled></textarea>
							<br/>
						...
						<div class='col-sm-5'>
							...
							<p><i class='fa fa-keyboard-o fa-fw'></i> <b>Berat</b></p>
							<!--input type="text" class='form-control' id='beratkir' name='beratkir' placeholder="berat" style='resize: vertical; width:100%;' /-->
							<textarea name='beratkir' id='beratkir' class='form-control' rows='1' placeholder="Data Penerima" style='resize: vertical; width:100%;aligment:right'></textarea>
							
							<br/>
							<p><i class='fa fa-keyboard-o fa-fw'></i> <b>Tarif</b></p>
							...
							<textarea name='catatan' id='tarif' class='form-control' rows='4' placeholder="Data Penerima" style='resize: vertical; width:100%;aligment:right'disabled></textarea>
...
$('#cekOrder').on('click', function (evt) {
			...
			$.ajax ({ 
					 ...
					 //  data :{kodepossip:kodepossip,kodepossial:kodepossial,berat:berat,anb:anb},
					   ...
					   success: function (response) {
						 // $('#pengirim').html(response.rc_mess);
